...
urlpatterns = [
    ...
    path('books/<int:pk>/update/', views.BookDetailView.as_view(), name='books/update'),  # PUT/PATCH update
    path('books/<int:pk>/delete/', views.BookDetailView.as_view(), name='books/delete'),  # DELETE
